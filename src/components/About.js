...
export default function About() {
    const [myStyle, setColor] = useState(
        ...
        const [btnText, setBtnText] = useState('Changed to dark')
    const ChangeColor = () =>{
...
<br/>
<button onClick={ChangeColor} className="btn btn-primary" type="button">
    {btnText}
</button>
</div>
